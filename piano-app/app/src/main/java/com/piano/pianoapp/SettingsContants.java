...
import com.piano.pianoapp.util.SettingConstant;
...
public class SettingsContants {
    ...
    static {
        ...
        DEFAULT_SETTINGS.put(Constant.APPLY_SELECT_INSTRUMENT, false);
        ...
        DEFAULT_SETTINGS.put(Constant.AUTO_BACKUP_SETTING, false);
