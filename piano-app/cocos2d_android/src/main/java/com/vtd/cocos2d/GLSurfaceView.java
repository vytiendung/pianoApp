...
public class GLSurfaceView extends SurfaceView implements
	...
	public void setEnterFrameListener(EnterFrameListener listener){
		mGLThread.setEnterFrameListener(listener);
	}
	...
	static class GLThread extends Thread {
		...
		EnterFrameListener enterFrameListener;
		...
		private void dispatchDrawFrame(){
			...
			lastTime = currentTime;
		   	if (enterFrameListener != null){
			    enterFrameListener.onEnterFrame(deltaTime);
		    }
		}
